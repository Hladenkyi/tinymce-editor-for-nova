...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    imageUploader: function imageUploader(blobInfo, progress) {
      var _this = this;
      return new Promise(function (resolve, reject) {
        var formData = new FormData();
        formData.append('file', blobInfo.blob(), blobInfo.filename());
        formData.append('field', _this.field.attribute);
        Nova.request().post("/nova-vendor/editor/".concat(_this.resourceName, "/image-manager"), formData).then(function (response) {
    ...
    setup: function setup(editor) {
      ...
      var field = this.field.attribute;
      editor.on("keydown", function (e) {
        if ((e.keyCode === 8 || e.keyCode === 46) && tinymce.activeEditor.selection) {
          ...
          if (selectedNode && selectedNode.nodeName === 'IMG' || selectedNode && selectedNode.nodeName === 'FIGURE') {
            var _selectedNode$src;
            var imageSrc = (_selectedNode$src = selectedNode.src) !== null && _selectedNode$src !== void 0 ? _selectedNode$src : selectedNode.firstChild.src;
            Nova.request()["delete"]("/nova-vendor/editor/".concat(resource, "/image-manager"), {
              data: {
                url: imageSrc,
                field: field
              }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }, null, 8 /* PROPS */, ["id", "api-key", "modelValue", "init", "plugins", "toolbar"])];
    }),
    _: 1 /* STABLE */
...
Nova.booting(function (app, store) {
  app.component('detail-editor', _components_DetailField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('form-editor', _components_FormField__WEBPACK_IMPORTED_MODULE_1__["default"]);
});
...
/* harmony import */ var _var_www_backend_nova_components_Editor_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_var_www_backend_nova_components_Editor_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkhladenkyi_editor"] = self["webpackChunkhladenkyi_editor"] || [];
